...
humaneval_70b_paths = [
    'results/llama3_70b_humaneval_cgo/results_merged_2.json',
    'results/llama3_70b_humaneval_plan/results_merged_2.json',
    'results/llama3_70b_humaneval_codecot/results_merged_2.json',
    'results/llama3_70b_humaneval_zerocot/results_merged_2.json',
    'results/llama3_70b_humaneval_pseudo/results_merged_2.json',
]
...
pivot_df.to_csv("avg_tokens/llama3_70b_token_length.csv", float_format="%.2f")
