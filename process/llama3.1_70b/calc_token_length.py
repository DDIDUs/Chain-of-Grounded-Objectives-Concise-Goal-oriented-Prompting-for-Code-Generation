...
livecodebench_70b_paths = [
    'results/llama3.1_70b_live_cgo/results_merged_2.json',
    'results/llama3.1_70b_live_plan/results_merged_2.json',
    'results/llama3.1_70b_live_codecot/results_merged_2.json',
    'results/llama3.1_70b_live_zerocot/results_merged_2.json',
    'results/llama3.1_70b_live_pseudo/results_merged_2.json',
]
...
pivot_df.to_csv("avg_tokens/llama3.1_70b_token_length.csv", float_format="%.2f")
